    ...
    textAlign: "center",
      ...
      <div className="container my-4">
        ...
        {shopWithShopkepper.length > 0 ? (
          shopWithShopkepper.map((shopwithkeep, index) => (
            <div className="card p-3 mb-3" key={index}>
              <div className="d-flex align-items-center">
                ...
                <div className="me-3">
                  ...
                  >
                    <img
                      src={shopwithkeep.profilePicture || shopwithkeep.shop?.shopPicture}
                      alt="Shop"
...
>
  ...
  />
 <h3 style={{ fontWeight: "700", marginBottom: "10px", color: "#ff6600" }}>
  Whoops! Nothing Here...
</h3>
<p style={{ fontSize: "18px", lineHeight: "1.5", color: "#777", maxWidth: "400px" }}>
  We gave it our best shot, but there are no requests at the moment. <br />
