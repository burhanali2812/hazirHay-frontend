...
function ShopKepperDashboard({ setUpdateAppjs, setKey }) {
  ...
  const cancelRequestPercent = shop
    ? Math.min((shop.cancelRequest / 5) * 100, 100)
    : 0;
            ...
            {cancelPercent >= 80 && (
              ...
              >
                ...
                <small className="text-muted">
                  You have made{" "}
                  <span className="fw-semibold text-dark">4 cancellations</span>
                  . Once you reach{" "}
                  <span className="fw-semibold text-dark">5 cancellations</span>
                  , your account will be{" "}
                  <span className="fw-semibold text-danger">
                    temporarily restricted for 7 days
                  </span>
                  .
                </small>
              </div>
            ...
            <div key={index} className="col-6 col-md-6 col-lg-6">
              ...
              >
                <div className="d-flex flex-column align-items-center justify-content-center">
                  ...
                  <h6 className="fw-semibold text-secondary mb-0 small">
                    {card.title}
                  </h6>
                </div>

                <h4 className="fw-bold text-dark mt-2 mb-1 small">
                  {card.count}
                </h4>
              ...
              <div className="modal-body text-center p-4">
                <div className="mb-3">
                  ...
                  <p className="text-muted mb-0" style={{ fontSize: "14px" }}>
                    ...
                    <strong>End Date</strong> to view orders placed between
                    these dates.
                  </p>
                </div>
