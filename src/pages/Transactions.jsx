  ...
  return (
    <div className="container my-2">
      ...
      <div className="mb-3 d-flex justify-content-between align-items-center">
        ...
        <button
          className="btn-sm btn btn-outline-primary px-2"
                  ...
                  <>
                      ...
                      >
                        ...
                        >
                          ...
                          <div className="d-flex justify-content-center gap-3">
                            <a
                              href={`tel:${
                                selectedTransaction.workerId?.phone || ""
                              }`}
                        ...
                        >
                          ...
                          >
                            {selectedTransaction.customerId?.name?.[0]?.toUpperCase() ||
                              "C"}
                          </div>
                          <p
                            className="fw-semibold mb-1 text-dark"
                          ...
                          <span className="badge bg-success text-light mb-2 small">
                            Customer
                          </span>
                          ...
                          <div className="d-flex justify-content-center gap-3">
                            <a
                              href={`tel:${
                                selectedTransaction.customerId?.phone || ""
                              }`}
                              className="text-decoration-none text-primary"
                              title="Call Customer"
                            >
                    ...
                    <div className="border-top pt-2">
                      ...
                      <div className="d-flex justify-content-between mb-1">
                        ...
                        <span className="fw-semibold">
                          Rs.{" "}
                          {selectedTransaction.deliveryCharge?.toFixed(0) || 0}
                          /-
                        </span>
                      </div>
                      <div className="d-flex justify-content-between fw-bold border-top pt-1">
                        ...
                        <span className="text-success">
                          Rs.{" "}
                          {selectedTransaction.totalPayable?.toFixed(0) || 0}/-
                        </span>
                      </div>
                    </div>
                  </>
